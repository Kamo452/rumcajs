...
<head>
    ...
    <title>Rumcajs / Zobacz profil </title>
</head>
<body>
    ...
    <div id="naglowek">
        <img src="img/logo.png" width="64px" height="64px" ><h3>Rumcajs / Zobacz profil</h3>
    </div>
    ...
    <?php 
        try {
            ...
            $zapytanie = "SELECT * FROM uzytkownicy WHERE uzytkownicy.userID = " . $_GET['userid'];
            ...
            echo "<section id='posty'>";
                ...
                if ($rekord['banned'] != 'Nigdy') {
                    echo "<i style='color: red'>[Konto zostało zablokowane przez administratora]</i>";
                }
